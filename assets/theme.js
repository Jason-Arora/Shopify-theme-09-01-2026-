      ...
      value: function _onProductAdded(event) {
        ...
        this._onCartRefresh().then(function () {
          if (window.theme.pageType !== 'cart') {
            ...
            // added fix window width 960 for mobile scroll only
            if (window.theme.cartType === 'drawer' && !_this3.options['useStickyHeader'] && window.innerWidth < 960) {
              window.scrollTo({
                top: 0,
                behavior: 'smooth'
              });
  ...
  var SearchBar = /*#__PURE__*/function () {
    ...
    _createClass(SearchBar, [{
      ...
      value: function _onInputFocus() {
        this.element.classList.add('is-fixeds');
